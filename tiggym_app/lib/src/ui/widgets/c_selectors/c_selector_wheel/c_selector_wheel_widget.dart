...
import 'c_selector_wheel_wheel_widget.dart';

class CSelectorWheelWidget<T> extends StatefulWidget {
  ...
  @override
  State<CSelectorWheelWidget<T>> createState() => _CSelectorWheelWidgetState<T>();
}

class _CSelectorWheelWidgetState<T> extends State<CSelectorWheelWidget<T>> {
  ...
  void initState() {
    ...
    _controller = FixedExtentScrollController()..addListener(() => _streamController.sink.add(widget.convertIndexToValue(_controller.selectedItem).value));
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Align(
          alignment: Alignment.center,
          child: CSelectorWheelWheelWidget(
