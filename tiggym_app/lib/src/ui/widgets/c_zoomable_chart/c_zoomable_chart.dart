...
class CZoomableChart extends StatefulWidget {
  const CZoomableChart({
    super.key,
    required this.maxX,
  ...
  @override
  State<CZoomableChart> createState() => _CZoomableChartState();
}

class _CZoomableChartState extends State<CZoomableChart> {
  late double minX;
  late double maxX;
