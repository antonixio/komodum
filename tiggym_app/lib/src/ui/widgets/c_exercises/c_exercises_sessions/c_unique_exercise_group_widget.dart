...
class CUniqueExerciseSessionGroupWidget extends StatefulWidget {
  ...
  const CUniqueExerciseSessionGroupWidget({
    super.key,
  ...
  @override
  State<CUniqueExerciseSessionGroupWidget> createState() => _CUniqueExerciseSessionGroupWidgetState();
}

class _CUniqueExerciseSessionGroupWidgetState extends State<CUniqueExerciseSessionGroupWidget> {
  @override
      ...
      (_) => ListView(
        ...
        children: [
          ListTile(
            ...
            onTap: () async {
              context.pop();
              await context.showMaterialModalBottomSheet((context) => CReorderSetsWidget(sets: widget.exerciseGroup.exercises.first.groupSets));
            },
