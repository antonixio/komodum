...
class CCompoundExerciseSessionGroupWidget extends StatefulWidget {
  ...
  const CCompoundExerciseSessionGroupWidget({
    super.key,
  ...
  @override
  State<CCompoundExerciseSessionGroupWidget> createState() => _CCompoundExerciseSessionGroupWidgetState();
}

class _CCompoundExerciseSessionGroupWidgetState extends State<CCompoundExerciseSessionGroupWidget> {
  @override
...
class CCompoundExerciseSetGroupWidget extends StatelessWidget {
  ...
  final void Function(ExerciseGroupTrainingSessionModel exerciseSetGroup)? onChanged;
